...
- `infra` - AWS CDK infrastructure code (in development)
...
## Viewing Completed Implementation

This repository is currently on the `starter` branch, which contains the initial setup and frontend application. To view the completed implementation with full infrastructure and backend integration, please checkout the `main` branch:
